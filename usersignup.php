...
if(isset($_POST['submitid']))
    ...
    if(isset($_POST['submitsignup']))
    {
        ...
        $query2="INSERT INTO userdb(UserName,Contact,Email,Location,Password) VALUES('$UserName','$Contact','$Email','$Location','$Password');";
        $res2=mysqli_query($conn,$query2);
        

        
        echo "<script>alert('You are successfully Registered!');</script>";
        echo "<script>window.location.href='./userlogin2.php';</script>";
...
<div class="container">
        ...
        <h1> User registration page</h1>
            ...
            <form id="sign-up-data" class="sign-up-data" method="post" action="usersignup.php" >
                
                <label for="text" >User Name</label>
                <input type="text" id="name" placeholder="Full name" name="UserName" required minlength="2" maxlength="100" />
