...
$sql ="SELECT * FROM userdb WHERE Name = '$Name' and Password = '$Password'";
...
?>
    <div class="main-container">
        ...
        data-aos-easing="ease-in-out">
            <h1>USER Login</h1>
            <form id="admin_form" action="userview.php" method="post">
                ...
                <br>
                <a href="usersignup.php" style="text-decoration:none;color:black">Make new user account!!</a>
